            ...
            <div class="card-body">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 text-center mb-4">
                        ...
                        <form action="<?= base_url('home/editfotoadmin') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <form action="<?= base_url('Home/deletefotoadmin') ?>" method="post" onsubmit="return confirm('Are you sure you want to delete your profile picture?');">
                    ...
                    <!-- Informasi Profile -->
                    <div class="col-md-8">
                        <form action="<?= base_url('home/aksi_e_profileadmin') ?>" method="POST">
                            <input type="hidden" name="id" value="<?= $dennis->id_user ?>">
                            <div class="form-row">

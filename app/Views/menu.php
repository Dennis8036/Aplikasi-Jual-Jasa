...
<!--         <symbol xmlns="http://www.w3.org/2000/svg" id="user" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="9" r="3"/><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" d="M17.97 20c-.16-2.892-1.045-5-5.97-5s-5.81 2.108-5.97 5"/></g></symbol>
        ...
        <symbol xmlns="http://www.w3.org/2000/svg" id="pet" viewBox="0 0 14 14"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M1.5 9.5c.552 0 1-.672 1-1.5s-.448-1.5-1-1.5s-1 .672-1 1.5s.448 1.5 1 1.5m3-4.5c.552 0 1-.672 1-1.5S5.052 2 4.5 2s-1 .672-1 1.5s.448 1.5 1 1.5m5 0c.552 0 1-.672 1-1.5S10.052 2 9.5 2s-1 .672-1 1.5s.448 1.5 1 1.5m3 4.5c.552 0 1-.672 1-1.5s-.448-1.5-1-1.5s-1 .672-1 1.5s.448 1.5 1 1.5M10 10c0 1.38-1.62 2-3 2s-3-.62-3-2s1-3.5 3-3.5s3 2.12 3 3.5"/></symbol>
                  ...
                  <style>
                .dropdown-item {
                    font-weight: bold; /* Membuat semua item dropdown lebih tebal */
                    color: #343a40; /* Mengatur warna teks menjadi abu-abu gelap */
                    transition: background-color 0.3s; /* Menambahkan efek transisi pada latar belakang */
                }

                .dropdown-item:hover {
                    background-color: #f8f9fa; /* Mengubah latar belakang saat hover */
                }
                        header {
            position: fixed; /* Membuat posisi header tetap */
            top: 0; /* Menempelkan header di bagian atas halaman */
            left: 0; /* Menempelkan header di bagian kiri halaman */
            width: 100%; /* Membuat lebar header 100% */
            z-index: 1000; /* Mengatur z-index agar header di atas elemen lain */
            background-color: white; /* Latar belakang header */
        ...
        /* Style untuk konten */
        .content {
            height: 2000px; /* Tinggi konten untuk demonstrasi scroll */
    ...
    <div class="row py-3 border-bottom">
      ...
      <div class="col-sm-4 col-lg-2 text-center text-sm-start d-flex gap-3 justify-content-center justify-content-md-start">
        <div class="d-flex align-items-center my-3 my-sm-0">
          <a>
            <img src="<?= base_url('images/sph.jfif')?>" alt="logo" class="img-fluid" width="120" height="auto">
          </a>
        </div>
        ...
        <div class="search-bar row bg-light p-2 rounded-4">
          ...
          <div class="col-11 col-md-7">
            <form id="search-form" class="text-center" action="index.html" method="post">
              <input type="text" class="form-control border-0 bg-transparent" placeholder="Cari jasa">
            </form>
          </div>
          <div class="col-1">
      ...
      <div class="col-lg-4">
        <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
            ...
            <a href="<?= base_url('Home/dashboardadmin')?>" class="nav-link">Admin</a>
          </li>
          <?php } ?>
          <li class="nav-item active">
          ...
          <!-- Logika untuk menampilkan link Masuk atau Profil -->
          <?php if (!session()->get('id_user')): ?>
            <li class="nav-item active">
              <a href="<?= base_url('Home/login')?>" class="nav-link">Masuk</a>
            </li>
          <?php else: ?>
        </ul>
      </div>
      ...
      <div class="col-sm-8 col-lg-2 d-flex gap-5 align-items-center justify-content-center justify-content-sm-end">
        <ul class="d-flex justify-content-end list-unstyled m-0">
          ...
          <li>
            <a href="" class="mx-3" style="color: #6c757d;"> <!-- Warna abu-abu -->
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16">
                <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zm3.5-2a5.5 5.5 0 0 0-11 0H1a1 1 0 0 0 0 2h12a1 1 0 0 0 0-2h-1.5zM8 1a5 5 0 0 0-5 5v3.5c0 1.387-.87 2.634-2 3.1V15h14v-2.4c-1.13-.466-2-1.713-2-3.1V6a5 5 0 0 0-5-5z"/>
              </svg>
            </a>
          </li>
          <li class="mx-3"> <!-- Menambahkan margin di sini -->
            <a href="#" class="" style="color: #6c757d;"> <!-- Warna abu-abu -->
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm14 0H2v1.5l6 3.5l6-3.5V4z"/>
              </svg>
            </a>
          </li>

  <div style="height: 35px; width: 2px; background-color: #6c757d;" class="mx-4"></div>

          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" data-bs-toggle="dropdown" id="profileDropdown">
              <img src="<?= ($dennis->foto_profile) ? base_url('images/img/' . $dennis->foto_profile) : base_url('images/img/fotouser.jfif') ?>" alt="Profile" class="rounded-circle" width="40" height="40">
              <h5 class="card-title ms-2 mb-0"><?= session()->get('username') ?></h5>
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown shadow" aria-labelledby="profileDropdown">
              <a class="dropdown-item fw-bold" href="<?= base_url('Home/profile') ?>">
                <i class="ti-user me-2"></i>
                Profile
              </a>
              <a class="dropdown-item fw-bold" href="<?= base_url('Home/changepassword') ?>">
                <i class="ti-key me-2"></i>
                Change Password
              </a>
              <a class="dropdown-item fw-bold" href="<?= base_url('Home/lockscreen') ?>">
    ...
    <section style="background-image: url('<?php echo base_url('images/bbcc.png'); ?>'); background-repeat: no-repeat; background-size: cover;">
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            <h2 class="display-1 ls-1"><span class="fw-bold text-primary">Jasa Digital</span> <span class="fw-bold">Freelancer</span></h2>
            <p class="fs-4"></p>
            <div class="d-flex gap-3">
...
<a href="category.html" class="nav-link swiper-slide text-center" style="margin-right: 20px;">
  <img src="<?= base_url('images/desain.jfif')?>" class="rounded-circle" alt="Category Thumbnail" style="width: 210px; height: 210px;">
  <h4 class="fs-6 mt-3 fw-normal category-title">Desain Grafis</h4>
</a>

<a href="category.html" class="nav-link swiper-slide text-center" style="margin-left: 30px;">
  <img src="<?= base_url('images/webtes.jfif')?>" class="rounded-circle" alt="Category Thumbnail" style="width: 210px; height: 210px;">
  <h4 class="fs-6 mt-2 fw-normal category-title" style="margin-right: 20px; text-align: right;">Website & Pemograman</h4>
</a>

<a href="category.html" class="nav-link swiper-slide text-center" style="margin-left: 30px;">
  <img src="<?= base_url('images/video.jpg')?>" class="rounded-circle" alt="Category Thumbnail" style="width: 210px; height: 210px;">
  <h4 class="fs-6 mt-2 fw-normal category-title" style="margin-right: 20px; text-align: right;">Video, Fotografi & Audio</h4>
</a>
 <a href="category.html" class="nav-link swiper-slide text-center" style="margin-left: 30px;">
  <img src="<?= base_url('images/penulisan.jfif')?>" class="rounded-circle" alt="Category Thumbnail" style="width: 210px; height: 210px;">
  <h4 class="fs-6 mt-2 fw-normal category-title" style="margin-right: 20px; text-align: right;"> Penulisan & Penerjemahan</h4>
</a>
 <a href="category.html" class="nav-link swiper-slide text-center" style="margin-left: 30px;">
  <img src="<?= base_url('images/pemasaran.png')?>" class="rounded-circle" alt="Category Thumbnail" style="width: 210px; height: 210px;">
  <h4 class="fs-6 mt-2 fw-normal category-title" style="margin-right: 20px; text-align: right;"> Pemasaran & Periklanan</h4>
</a>
 <a href="category.html" class="nav-link swiper-slide text-center" style="margin-left: 30px;">
  <img src="<?= base_url('images/konsultasi.jpg')?>" class="rounded-circle" alt="Category Thumbnail" style="width: 210px; height: 210px;">
  <h4 class="fs-6 mt-2 fw-normal category-title" style="margin-left: 52px; text-align: left;"> Konsultasi</h4>
</a>
 <a href="category.html" class="nav-link swiper-slide text-center" style="margin-left: 30px;">
  <img src="<?= base_url('images/gaya.png')?>" class="rounded-circle" alt="Category Thumbnail" style="width: 210px; height: 210px;">
  <h4 class="fs-6 mt-2 fw-normal category-title" style="margin-left: 52px; text-align: left;"> Gaya Hidup</h4>
</a>
      ...
      <div class="container-lg">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between mb-5">
              <h2 class="section-title">Desain Profesional. Harga Terjangkau</h2>

              <div class="d-flex align-items-center">
                <a href="#" class="btn btn-primary me-2">View All</a>
                <div class="swiper-buttons">
                      <button class="swiper-prev category-carousel-prevv btn btn-yellow">❮</button>
                      <button class="swiper-next category-carousel-nextv btn btn-yellow">❯</button>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            slidesPerView: 4, // Adjust to show 4 items
            spaceBetween: 20, // Space between items
            navigation: {
                   nextEl: ".category-carousel-nextv", // Kelas unik untuk tombol Next
            prevEl: ".category-carousel-prevv", // Kelas unik untuk tombol Prev
            },
            breakpoints: {
                768: { slidesPerView: 2 }, // For medium devices
                1024: { slidesPerView: 4 }, // For large devices
            }
        });
        });
            ...
            <div class="swiper">
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-10.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-11.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-12.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-13.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-14.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-15.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-16.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-17.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-18.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Honeycrisp Apples</h3>
    ...
    <section>
      <div class="container-lg">
        ...
        <div class="bg-secondary text-light py-5 my-5" style="background: url('<?php echo base_url('images/banner-newsletter.jpg'); ?>'); no-repeat; background-size: cover;">
          <div class="container">
            ...
            <div class="swiper">
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-19.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
            ...
            <div class="swiper">
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-20.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Sunstar Fresh Melon Juice</h3>
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-1.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Whole Wheat Sandwich Bread</h3>
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-21.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Sunstar Fresh Melon Juice</h3>
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-22.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                ...
                <div class="product-item swiper-slide">
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="<?= base_url('images/product-thumb-23.png')?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <div class="d-flex flex-column text-center">
                    <h3 class="fs-6 fw-normal">Sunstar Fresh Melon Juice</h3>
 ...
 <!--    <section id="latest-blog" class="pb-4">
            ...
            <div class="row justify-content-center align-items-center">
              <div class="col-md-4">
                ...
                <div class="d-flex gap-2 flex-wrap mb-5">
                  <a href="#" title="App store"><img src="<?= base_url('images/img-app-store.png')?>" alt="app-store"></a>
                  <a href="#" title="Google Play"><img src="<?= base_url('images/img-google-play.png')?>" alt="google-play"></a>
                </div>
              </div>
              <div class="col-md-5">
                <img src="<?= base_url('images/banner-onlineapp.png')?>" alt="phone" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="py-4">
      <div class="container-lg">
        ...
        <a href="#" class="btn btn-warning me-2 mb-2">Desain Logo</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Review Marketplace</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Pembuatan Website</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Pembuatan Video</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Pembuatan Artikel</a>

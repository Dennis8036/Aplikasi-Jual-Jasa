...
{ 
    ...
    public function getJasaWithUserInfo()
{
    return $this->db->table('tb_jasa')
        ->join('tb_user', 'tb_jasa.id_user = tb_user.id_user')
        ->select('tb_jasa.*, tb_user.username, tb_user.foto_profile')
        ->get()
        ->getResult();
}
